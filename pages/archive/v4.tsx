  ...
  return (
    <Switch className="inline-flex items-center text-white space-x-4 group">
      <div className="flex w-10 h-6 rounded-full items-center border-2 border-transparent bg-zinc-600 group-data-[selected]:bg-green-5000 transition  group-data-[focus-visible]:ring-2 ring-offset-2 ring-offset-zinc-900">
        <div className="inline-flex group-data-[selected]:translate-x-4 transition group-data-[selected]:group-data-[pressed]:translate-x-2 isolate">
          <div className="bg-white w-2.5 h-5 rounded-l-full" />
          <div className="w-2 scale-x-0 h-5 bg-white group-data-[pressed]:scale-x-100 transition-all origin-left mix-blend-plus-lighter" />
          <div className="bg-white -translate-x-2 group-data-[pressed]:translate-x-0 w-2.5 h-5 rounded-r-full transition-all mix-blend-plus-lighter" />
        </div>
      </div>
      <span>{children}</span>
    </Switch>
