      ...
      {({ isSelected, isPressed }) => (
        ...
        >
          <motion.div
            ...
            // }}
            className={`flex w-10 h-6 rounded-full transition-colors items-center border-2 border-transparent bg-zinc-600 group-data-[selected]:bg-green-500 group-data-[focus-visible]:ring-2 ring-offset-2 ring-offset-zinc-900`}
          >
            <motion.div
              animate={{
