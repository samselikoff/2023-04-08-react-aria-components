...
function Toggle({
  ...
  return (
    <Switch {...props} className="inline-flex items-center space-x-4 group">
      <div className="flex w-9 h-6 rounded-full items-center border-2 border-transparent bg-zinc-600 group-data-[selected]:bg-green-500 transition group-data-[focus-visible]:ring-2 ring-offset-2 ring-offset-zinc-900 duration-200">
